...
const COPY = {
  en: {
    ...
    sections: [
      ['01 — Brand point of view', 'Darkness as a form of authorship.', 'MAVRA is designed for people who treat their home as a personal world, not a temporary costume. The visual language is intentional, warm and precise: dark surfaces, controlled light and objects that feel collected rather than mass-decorated.'],
